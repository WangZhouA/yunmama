...
import com.saiyi.pregnantmother.login.presenter.RegisterPresenter;
...
public class RegisterActivity extends BKMVPActivity<RegisterPresenter> {
    ...
    public void onRegisterSuccess(String msg) {
        ...
        intent.putExtra(BUNDLE_KEY_REGISTER_RESULT, etPhone.getText().toString());
    ...
    protected void onClickRegister(View view) {
        UiUtil.setVisibility(loggerTv, View.INVISIBLE);
        getPresenter().register(etPhone.getText().toString(),
